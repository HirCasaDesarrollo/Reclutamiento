...
namespace Prueba_BackEnd_Jr.Migrations
{
    ...
    [Migration("20221222084253_OneToOneClientesAjustes")]
    partial class OneToOneClientesAjustes
    {
            ...
            modelBuilder.Entity("Prueba_BackEnd_Jr.Models.Ajuste", b =>
                {
                    b.HasOne("Prueba_BackEnd_Jr.Models.Cliente", "Cliente")
                        .WithOne("Ajuste")
                        .HasForeignKey("Prueba_BackEnd_Jr.Models.Ajuste", "ClienteID")
